...
- **S/4HANA Cloud (Public)** — **고전 Dynpro 금지**. RAP + Fiori Elements / `if_oo_adt_classrun` / SALV-only로 자동 리다이렉트. 금지 구문 + Cloud 대체 API 전체 목록: `skills/create-program/cloud-abap-constraints.md`
